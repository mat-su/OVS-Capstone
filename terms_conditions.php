...
<head>
    ...
    <link rel="stylesheet" href="css/style_terms_condition.css">
    <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.min.css">

    <!--Font-->
    <!--Rica: I remove the lato font and add this line for the font-->
...
<body>
    ...
    <div class="container">
        ...
        <div class="bodyTAC">
            ...
            <h5>
                <bold>LIMITATION ON LIABILITY, DISPUTES AND INDEMNIFICATION
            </h5>
        ...
        <div class="bodyTAC">
            ...
            <h5>
                <bold>WHAT USER DATA AND INFORMATION WE COLLECT
            </h5>
            ...
            <h5>
                <bold>WHY WE COLLECT DATA AND INFORMATION AND HOW WE USE IT
            </h5>
            ...
            <h5>
                <bold>SAFEGUARDING, SECURING AND CONFIDENTIALITY OF YOUR DATA AND INFORMATION
            </h5>
            ...
            <h5>
                <bold>RESTRICTING THE COLLECTION OF YOUR PERSONAL DATA AND ITS RETENTION TO THE WEBSITE AND SYSTEM
            </h5>
